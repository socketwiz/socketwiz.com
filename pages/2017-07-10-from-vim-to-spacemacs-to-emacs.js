...
export default class Article extends Component {
    render() {
        return <Main title="From VIM to Spacemacs to Emacs">
            <h2>From VIM to Spacemacs to Emac</h2>
            ...
            <p>
                ...
                is simply Emacs configured for VIM users...at least thats what it started off life as.
            ...
            <h4>Spacemacs</h4>
            <p>
                I gave Spacemacs an honest try for around 3 months.  I was immediatly productive becuase
                ...
                them later and ORG mode is definitly the ticket there.  Thirdly having a package manager
            ...
            <p>
                ...
                is that it seemed like it kept forgetting which mode the file was in.  Thats the best way
            ...
            <p>
                ...
                created.  I use evil mode which means I utlize what VIM would call text objects.  One thing Emacs
                ...
                triggers this because it doesn&#39;t happen all the time however heres what happens.  Say you
                are on a line that is indented 4 spaces, you type out some code, hit enter twice to seperate
            ...
            <p>
                ...
                language. One thing thats missing from both VIM and Emacs is a JavaScript debugger.  However as a
                ...
                here: <a href="https://github.com/socketwiz/dotfiles/tree/master/.emacs.d" target="_blank" rel="noopener noreferrer">https://github.com/socketwiz/dotfiles/tree/master/.emacs.d</a>
            </p>
